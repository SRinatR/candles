      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 text-sm">
            ...
            {product.scent && <p className="flex items-center"><Droplets className="mr-2 h-4 w-4 text-muted-foreground"/> <strong className="font-medium">{dictionary.scentLabel}</strong> <span className="ml-1">{product.scent?.name?.[locale] || product.scent?.name?.en || product.scent?.name?.uz || product.scent?.slug || product.scent}</span></p>}
            {product.material && <p className="flex items-center"><Palette className="mr-2 h-4 w-4 text-muted-foreground"/> <strong className="font-medium">{dictionary.materialLabel}</strong> <span className="ml-1">{product.material?.name?.[locale] || product.material?.name?.en || product.material?.name?.uz || product.material?.slug || product.material}</span></p>}
